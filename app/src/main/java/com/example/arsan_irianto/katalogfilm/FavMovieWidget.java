...
public class FavMovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.arsan_irianto.katalogfilm.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.arsan_irianto.katalogfilm.EXTRA_ITEM";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        /*views.setTextViewText(R.id.stack_view, R.id.banner_text);*/
